...
load("May2023.RData")
library(igraph)
CentralitiesMAY <- data.frame(degree = igraph::degree(bn1),
                              closeness =igraph::closeness(bn1),
                              betweenness = igraph::betweenness(bn1),
                              Eigen.vector = igraph::eigen_centrality(bn1))
CentralitiesMAY <- CentralitiesMAY[1:4]
CentralitiesMAY <- CentralitiesMAY[order(-CentralitiesMAY$Eigen.vector.vector), ]
...
CentralitiesMAY <- head(CentralitiesMAY, 10)
